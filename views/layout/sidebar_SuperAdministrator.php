        ...
        <div class="menu">
            <ul class="list">
                ...
                <li <?php if ($_GET['controller'] == 'batches'){ ?> class="active" <?php } ?> >
                    ...
                    <ul class="ml-menu">
                        <li <?php if ($_GET['controller'] == 'batches' && $_GET['action'] == 'allBatches' || $_GET['action'] == 'viewBatch' || $_GET['action'] == 'assignTeacherClassroom' || $_GET['action'] == 'editBatch' || $_GET['action'] == 'viewAttendance' || $_GET['action'] == 'addAttendance' || $_GET['action'] == 'editAttendance' || $_GET['action'] == 'allExams' || $_GET['action'] == 'addExam' || $_GET['action'] == 'editExam' || $_GET['action'] == 'getParticipants'){ ?> class="active" <?php } ?> >
                            <a href="?controller=batches&action=allBatches">
                                List of Batches
                            </a>
                        </li>
                        <li <?php if ($_GET['controller'] == 'batches' && $_GET['action'] == 'addBatch'){ ?> class="active" <?php } ?> >
                            <a href="?controller=batches&action=addBatch">
                                Add New Batch
                            </a>
                        </li>
                        <li <?php if ($_GET['controller'] == 'batches' && $_GET['action'] == 'manageClassRoom' || $_GET['action'] == 'editClassRoom' || $_GET['action'] == 'searchByClassroom'){ ?> class="active" <?php } ?> >
                            <a href="?controller=batches&action=manageClassRoom">
                                Manage Classrooms
                            </a>
                        </li>
                        <li <?php if ($_GET['controller'] == 'batches' && $_GET['action'] == 'manageBatchType' || $_GET['action'] == 'editBatchType' || $_GET['action'] == 'searchByType'){ ?> class="active" <?php } ?> >
                            <a href="?controller=batches&action=manageBatchType">
                                Manage Batch types
                            </a>
                        </li>
                        <li <?php if ($_GET['controller'] == 'batches' && $_GET['action'] == 'manageBatchPeriod' || $_GET['action'] == 'editBatchPeriod' || $_GET['action'] == 'searchByPeriod'){ ?> class="active" <?php } ?>>
                            <a href="?controller=batches&action=manageBatchPeriod">
                                Manage Batch Periods
                            </a>
                        </li>
                    </ul>
                </li>  
...
<?php } ?>   
                        <li <?php if ($_GET['controller'] == 'users' && $_GET['action'] == 'addUser'){?> class="active" <?php } ?>>
                            <a href="?controller=users&action=addUser">
                                Add New User
                            </a>
                        </li>
                ...
                <li <?php if ($_GET['controller'] == 'notices'){ ?> class="active" <?php } ?> >
                    ...
                    <ul class="ml-menu">
                        <li <?php if ($_GET['controller'] == 'notices' && $_GET['action'] == 'allNotices' || $_GET['action'] == 'viewNotice' || $_GET['action'] == 'editNotice' || $_GET['action'] == 'searchNotice' || $_GET['action'] == 'searchNoticebyDate'|| $_GET['action'] == 'viewComments'|| $_GET['action'] == 'editComment'){ ?> class="active" <?php } ?> >
                            <a href="?controller=notices&action=allNotices">
                                View All Notices
                            </a>
                        </li>
                        <li <?php if ($_GET['controller'] == 'notices' && $_GET['action'] == 'addNotice'){ ?> class="active" <?php } ?> >
                            <a href="?controller=notices&action=addNotice">
                                Add New Notice
                            </a>
                        </li>
                    </ul>
