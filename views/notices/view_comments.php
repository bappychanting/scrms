    ...
    <div class="container-fluid">
        ...
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-teal">
                ...
                <li><a href="?controller=notices&action=viewNotice&id=<?php echo $_GET['id']; ?>"><i class="material-icons">details</i> View Notice</a></li>
                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="?controller=notices&action=editComment&id=<?php  echo $comment['id']; ?>">Update Comment</a></li>
                                    <li><a href="?controller=notices&action=deleteComment&id=<?php  echo $comment['id']; ?>">Delete Comment</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div class="body">
                        <?php  echo $comment['notice_comment']; ?>
                    </div>
                </div>
            </div>
<?php
