    ...
    <div class="container-fluid">
        ...
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-teal">
                ...
                <li class="active"><i class="material-icons">playlist_add</i> Add New Notice</li>
            </ol>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form_advanced_validation" method="post" action='?controller=notices&action=storeNotice' onsubmit="setFormSubmitting()"> 
                            ...
                            <label for="details">Add Notice Details</label>
                            <div class="form-group form-float">
