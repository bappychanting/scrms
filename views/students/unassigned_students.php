    ...
    <div class="container-fluid">
        ...
        <div class="block-header">
           <ol class="breadcrumb breadcrumb-col-teal">
                ...
                <li class="active"><i class="material-icons">warning</i> Batch Unassigned Students</li>
            </ol>
        </div>
        <!-- Basic Table -->
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            List of Students Without Assigned Batch
...
?>
                ...
                <a href='?controller=students&action=showStudentProfile&uname=<?php echo $user['username']; ?>' target="_blank" class="btn btn-success waves-effect" data-toggle="tooltip" data-placement="bottom" title="Show Student Profile"><i class="material-icons">account_box</i></a>
                                    ...
                                    <td>
                <a href='?controller=students&action=assignBatch&uname=<?php echo $user['username']; ?>' target="_blank" class="btn btn-default waves-effect" data-toggle="tooltip" data-placement="bottom" title="Assign Batch"><i class="material-icons">input</i></a>
                                    </td>
                                </tr>
<?php   
        $count++;   
